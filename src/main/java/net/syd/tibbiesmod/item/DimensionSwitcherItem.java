...
import net.syd.tibbiesmod.itemgroup.DimensionalObjectsItemGroup;
import net.syd.tibbiesmod.gui.DimensionPickerGui;
...
public class DimensionSwitcherItem extends SydsutilsModElements.ModElement {
	@ObjectHolder("sydsutils:dimension_switcher")
	public static final Item block = null;
	public DimensionSwitcherItem(SydsutilsModElements instance) {
		super(instance, 18);
	...
	public void onItemDropped(ItemTossEvent event) {
		if (event.getEntityItem().getItem().getItem() == block) {
			if (Minecraft.getInstance().currentScreen instanceof DimensionPickerGui.GuiWindow) {
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			super(new Item.Properties().group(DimensionalObjectsItemGroup.tab).maxStackSize(1).rarity(Rarity.EPIC));
			setRegistryName("dimension_switcher");
		}
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Dimension Switcher");
					}
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new DimensionPickerGui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
