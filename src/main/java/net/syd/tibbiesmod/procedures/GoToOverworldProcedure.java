...
public class GoToOverworldProcedure extends SydsutilsModElements.ModElement {
	public GoToOverworldProcedure(SydsutilsModElements instance) {
		super(instance, 21);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				System.err.println("Failed to load dependency entity for procedure GoToOverworld!");
			return;
		}
