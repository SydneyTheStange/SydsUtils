...
public class GoToNetherProcedure extends SydsutilsModElements.ModElement {
	public GoToNetherProcedure(SydsutilsModElements instance) {
		super(instance, 22);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				System.err.println("Failed to load dependency entity for procedure GoToNether!");
			return;
		}
