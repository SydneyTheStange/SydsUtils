...
public class GoToEndProcedure extends SydsutilsModElements.ModElement {
	public GoToEndProcedure(SydsutilsModElements instance) {
		super(instance, 23);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				System.err.println("Failed to load dependency entity for procedure GoToEnd!");
			return;
		}
