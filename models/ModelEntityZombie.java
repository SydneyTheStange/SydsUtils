...
public static class ModelEntityZombie extends EntityMonster {

	protected static final IAttribute bp = (new AttributeRanged("zombie.spawnReinforcements", 0.0D, 0.0D, 1.0D))
	...
	public ModelEntityZombie(World world) {
		super(world);
	...
	public boolean damageEntity(DamageSource damagesource, float f) {
		if (!super.damageEntity(damagesource, f)) {
			...
			if (entityliving != null && this.world.difficulty == EnumDifficulty.HARD
				...
				for (int l = 0; l < 50; ++l) {
					...
					if (World.a((IBlockAccess) this.world, i1, j1 - 1, k1)
							&& this.world.getLightLevel(i1, j1, k1) < 10) {
						entityzombie.setPosition((double) i1, (double) j1, (double) k1);
						if (this.world.b(entityzombie.boundingBox)
							...
							this.getAttributeInstance(bp).a(new AttributeModifier("Zombie reinforcement caller charge",
									-0.05000000074505806D, 0));
							entityzombie.getAttributeInstance(bp).a(new AttributeModifier(
	...
	public GroupDataEntity prepare(GroupDataEntity groupdataentity) {
		...
		if (object == null) {
			object = new GroupDataZombie(this, this.world.random.nextFloat() < 0.05F,
					this.world.random.nextFloat() < 0.05F, (EmptyClassZombie) null);
		}
		...
		if (object instanceof GroupDataZombie) {
			...
			if (groupdatazombie.a) {
				...
				if ((double) this.world.random.nextFloat() < 0.05D) {
					List list = this.world.a(EntityChicken.class, this.boundingBox.grow(5.0D, 3.0D, 5.0D),
							IEntitySelector.b);
		...
		this.getAttributeInstance(GenericAttributes.c)
				.a(new AttributeModifier("Random spawn bonus", this.random.nextDouble() * 0.05000000074505806D, 0));
		...
		if (this.random.nextFloat() < f * 0.05F) {
			this.getAttributeInstance(bp)
					.a(new AttributeModifier("Leader zombie bonus", this.random.nextDouble() * 0.25D + 0.5D, 0));
			this.getAttributeInstance(GenericAttributes.maxHealth)
					.a(new AttributeModifier("Leader zombie bonus", this.random.nextDouble() * 3.0D + 1.0D, 2));
			this.a(true);
		}
